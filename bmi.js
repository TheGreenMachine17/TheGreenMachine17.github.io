...
function calculateBmi()
{
  ...
  if(bmi < 18.5)
  {
    result = "Saimone is goodlooking.";
    displayResults();
  }
  else if(bmi >= 18.5 && bmi <= 24.9)
  {
    result = "Saimone is sexy af no matter what";
    displayResults();
  }
  else if(bmi >= 25.0 && bmi <= 29.9)
  {
    result = "Dont give a damn what the results say, Saimone got it going on! Period!";
    displayResults();
  }
  else if(bmi >= 30.0)
  {
    result = "Like I said, Saimone is fine AF, & I hope she know that ;)";
    displayResults();
  }
}
...
function displayResults()
{
  ...
  if(result == 'Like I said, Saimone is fine AF, & I hope she know that ;)')
  {
...
*/
  ...
  else if(result == 'Dont give a damn what the results say, Saimone got it going on! Period!')
  {
    //highlights row on table
...
*/
  ...
  else if(result == 'Saimone is sexy af no matter what')
  {
    //highlights row on table
...
*/
  ...
  else if(result == 'Saimone is goodlooking.')
  {
    //highlights row on table
